#ifndef REPOCHANGEDIALOG_H
#define REPOCHANGEDIALOG_H
...
class RepoChangeDialog : public QFramelessDialog
{
    Q_OBJECT
public:
    explicit RepoChangeDialog(bool resizeEnable = true,
                              bool shadowBorder = true,
                              bool winNativeEvent = true,
                              QWidget *parent = nullptr);
    ~RepoChangeDialog();
    void setRepoChangeID(QString id);
    void setRepoChangeCategory(QString category);
    void setRepoChangeName(QString name);
    void setRepoChangeRepo(QString repo);
    void setRepoChangeOldNumber(QString number);
    void setRepoChangeNewNumber(QString number);
private slots:
