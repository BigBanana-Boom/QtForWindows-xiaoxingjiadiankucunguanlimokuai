#ifndef OUTREPOREMOVEDIALOG_H
#define OUTREPOREMOVEDIALOG_H
...
class OutRepoRemoveDialog : public QFramelessDialog
{
    Q_OBJECT
public:
    explicit OutRepoRemoveDialog(bool resizeEnable = true,
    ...
    void setOutRepoRemoveName(QString name);
    void setOutRepoRemoveRepo(QString repo);
    void setOutRepoRemoveNumber(QString number);
private slots:
