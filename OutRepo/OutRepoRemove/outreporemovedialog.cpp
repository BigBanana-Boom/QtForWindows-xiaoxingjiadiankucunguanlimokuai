#include "outreporemovedialog.h"

OutRepoRemoveDialog::OutRepoRemoveDialog(bool resizeEnable,
                                         bool shadowBorder,
                                         bool winNativeEvent,
                                         QWidget *parent)
    ...
    CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("删 除 出 库");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &OutRepoRemoveDialog::onCloseButtonClicked);
...
void OutRepoRemoveDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
...
void OutRepoRemoveDialog::setOutRepoRemoveDateTime(QString datetime) {
    rowTwoContent->setText(datetime);
}
void OutRepoRemoveDialog::setOutRepoRemoveCategory(QString category) {
    rowThreeContent->setText(category);
}
void OutRepoRemoveDialog::setOutRepoRemoveName(QString name) {
    rowFourContent->setText(name);
}
void OutRepoRemoveDialog::setOutRepoRemoveRepo(QString repo) {
    rowFiveContent->setText(repo);
}
void OutRepoRemoveDialog::setOutRepoRemoveNumber(QString number) {
