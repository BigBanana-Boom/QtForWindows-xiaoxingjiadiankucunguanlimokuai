...
OutRepoAddDialog::OutRepoAddDialog(bool resizeEnable,
                                   bool shadowBorder,
                                   bool winNativeEvent,
                                   QWidget *parent)
      ...
      CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("新 增 出 库");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &OutRepoAddDialog::onCloseButtonClicked);
...
void OutRepoAddDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void OutRepoAddDialog::setOutRepoAddCategory(QString category) {
    rowOneContent->setText(category);
}
void OutRepoAddDialog::setOutRepoAddName(QString name) {
    rowTwoContent->setText(name);
}
void OutRepoAddDialog::setOutRepoAddRepo(QString repo) {
    rowThreeContent->setText(repo);
}
void OutRepoAddDialog::setOutRepoAddNumber(QString number) {
