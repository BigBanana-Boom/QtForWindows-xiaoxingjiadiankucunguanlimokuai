#ifndef OUTREPOCHANGEDIALOG_H
#define OUTREPOCHANGEDIALOG_H
...
class OutRepoChangeDialog : public QFramelessDialog
{
    Q_OBJECT
public:
    explicit OutRepoChangeDialog(bool resizeEnable = true,
                        bool shadowBorder = true,
                        bool winNativeEvent = true,
                        QWidget *parent = nullptr);
    ~OutRepoChangeDialog();
    void setOutRepoChangeTitle(QString title);
    void setOutRepoChangeID(QString id);
    void setOutRepoChangeDateTime(QString datetime);
    void setOutRepoChangeCategory(QString category);
    void setOutRepoChangeName(QString name);
    void setOutRepoChangeRepo(QString repo);
    void setOutRepoOriginalNumber(QString number);
    void setOutRepoChangeNumber(QString number);
private slots:
