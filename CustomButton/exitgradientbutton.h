#ifndef EXITGRADIENTBUTTON_H
#define EXITGRADIENTBUTTON_H
...
class ExitGradientButton : public QPushButton
{
    Q_OBJECT
public:
    explicit ExitGradientButton(QWidget *parent = nullptr);
    // 设置颜色****************************************************************************
