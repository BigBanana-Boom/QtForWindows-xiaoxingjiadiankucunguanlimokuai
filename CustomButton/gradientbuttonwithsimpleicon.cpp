#include "gradientbuttonwithsimpleicon.h"

GradientButtonWithSimpleIcon::GradientButtonWithSimpleIcon(QWidget* parent)
    : QPushButton(parent),
    ...
    // 总步数与当前步数***************************************************************
{
    ...
    connect(gradientTimer, &QTimer::timeout,
            this, &GradientButtonWithSimpleIcon::updateGradient);
    // 槽函数*****************************************************************************
}
void GradientButtonWithSimpleIcon::enterEvent(QEvent* event) {
...
void GradientButtonWithSimpleIcon::leaveEvent(QEvent* event) {
...
void GradientButtonWithSimpleIcon::updateGradient() {
...
void GradientButtonWithSimpleIcon::updateIcon() {
