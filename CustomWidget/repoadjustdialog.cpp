#include "repoadjustdialog.h"

RepoAdjustDialog::RepoAdjustDialog(bool resizeEnable,
                                   bool shadowBorder,
                                   bool winNativeEvent,
                                   QWidget *parent)
      ...
      CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("库 存 转 存");
    ...
    // 第二行****************************************************************************
    // 第三行****************************************************************************
    rowThreeLabel->setText("待转存库存旧位置：");
    ...
    // 跟该Pro的其它保持一致***********************************************************
    contentWidget->setFixedHeight(325);
    // 内容器件**************************************************************************
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &RepoAdjustDialog::onCloseButtonClicked);
...
void RepoAdjustDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void RepoAdjustDialog::setRepoAdjustCategory(QString category) {
    rowOneContent->setText(category);
}
void RepoAdjustDialog::setRepoAdjustName(QString name) {
    rowTwoContent->setText(name);
}
void RepoAdjustDialog::setRepoAdjustOldRepo(QString oldrepo) {
    rowThreeContent->setText(oldrepo);
}
void RepoAdjustDialog::setRepoAdjustNewRepo(QString newrepo) {
    rowFourContent->setText(newrepo);
}
void RepoAdjustDialog::setRepoAdjustNumber(QString number) {
