...
RepoChangeDialog::RepoChangeDialog(bool resizeEnable,
                                   bool shadowBorder,
                                   bool winNativeEvent,
                                   QWidget *parent)
    ...
    CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("修 改 库 存");
    ...
    // 第六行****************************************************************************
    // 第七行****************************************************************************
    rowSevenLabel->setText("确定修改该记录嘛？");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &RepoChangeDialog::onCloseButtonClicked);
...
void RepoChangeDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void RepoChangeDialog::setRepoChangeID(QString id) {
    rowOneContent->setText(id);
}
void RepoChangeDialog::setRepoChangeCategory(QString category) {
    rowTwoContent->setText(category);
}
void RepoChangeDialog::setRepoChangeName(QString name) {
    rowThreeContent->setText(name);
}
void RepoChangeDialog::setRepoChangeRepo(QString repo) {
    rowFourContent->setText(repo);
}
void RepoChangeDialog::setRepoChangeOldNumber(QString number) {
    rowFiveContent->setText(number);
}
void RepoChangeDialog::setRepoChangeNewNumber(QString number) {
