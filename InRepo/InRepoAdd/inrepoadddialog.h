#ifndef INREPOADDDIALOG_H
#define INREPOADDDIALOG_H
...
class InRepoAddDialog : public QFramelessDialog
{
    Q_OBJECT
public:
    explicit InRepoAddDialog(bool resizeEnable = true,
                             bool shadowBorder = true,
                             bool winNativeEvent = true,
                             QWidget *parent = nullptr);
    ~InRepoAddDialog();
    void setInRepoAddCategory(QString category);
    void setInRepoAddName(QString name);
    void setInRepoAddRepo(QString repo);
    void setInRepoAddNumber(QString number);
private slots:
