...
InRepoRemoveDialog::InRepoRemoveDialog(bool resizeEnable,
                                       bool shadowBorder,
                                       bool winNativeEvent,
                                       QWidget *parent)
    ...
    CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("删 除 入 库");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &InRepoRemoveDialog::onCloseButtonClicked);
...
void InRepoRemoveDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void InRepoRemoveDialog::setInRepoRemoveTitle(QString title) {
    contentWidgetTitle->setText(title);
}
void InRepoRemoveDialog::setInRepoRemoveID(QString id) {
    rowOneContent->setText(id);
}
void InRepoRemoveDialog::setInRepoRemoveDateTime(QString datetime) {
    rowTwoContent->setText(datetime);
}
void InRepoRemoveDialog::setInRepoRemoveCategory(QString category) {
    rowThreeContent->setText(category);
}
void InRepoRemoveDialog::setInRepoRemoveName(QString name) {
    rowFourContent->setText(name);
}
void InRepoRemoveDialog::setInRepoRemoveRepo(QString repo) {
    rowFiveContent->setText(repo);
}
void InRepoRemoveDialog::setInRepoRemoveNumber(QString number) {
