#include "inrepochangedialog.h"

InRepoChangeDialog::InRepoChangeDialog(bool resizeEnable,
                                       bool shadowBorder,
                                       bool winNativeEvent,
                                       QWidget *parent)
    ...
    CancelButton(new DialogGradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("修 改 入 库");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &InRepoChangeDialog::onCloseButtonClicked);
...
void InRepoChangeDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
...
void InRepoChangeDialog::setInRepoChangeDateTime(QString datetime) {
    rowTwoContent->setText(datetime);
}
void InRepoChangeDialog::setInRepoChangeCategory(QString category) {
    rowThreeContent->setText(category);
}
void InRepoChangeDialog::setInRepoChangeName(QString name) {
    rowFourContent->setText(name);
}
void InRepoChangeDialog::setInRepoChangeRepo(QString repo) {
    rowFiveContent->setText(repo);
}
void InRepoChangeDialog::setInRepoOriginalNumber(QString number) {
    rowSixContent->setText(number);
}
void InRepoChangeDialog::setInRepoChangeNumber(QString number) {
