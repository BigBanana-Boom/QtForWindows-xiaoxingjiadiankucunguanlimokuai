...
DoneChangeDialog::DoneChangeDialog(bool resizeEnable,
                                   bool shadowBorder,
                                   bool winNativeEvent,
                                   QWidget *parent)
    ...
    CancelButton(new GradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("修 改 已 定");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &DoneChangeDialog::onCloseButtonClicked);
...
void DoneChangeDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void DoneChangeDialog::setDoneChangeID(QString id) {
    rowOneContent->setText(id);
}
void DoneChangeDialog::setDoneChangeDateTime(QString datetime) {
    rowTwoContent->setText(datetime);
}
void DoneChangeDialog::setDoneChangeCategory(QString category) {
    rowThreeContent->setText(category);
}
void DoneChangeDialog::setDoneChangeName(QString name) {
    rowFourContent->setText(name);
}
void DoneChangeDialog::setDoneOriginalNumber(QString number) {
    rowFiveContent->setText(number);
}
void DoneChangeDialog::setDoneChangeNumber(QString number) {
