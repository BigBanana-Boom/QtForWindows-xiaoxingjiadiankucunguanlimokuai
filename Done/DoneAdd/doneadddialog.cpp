#include "doneadddialog.h"

DoneAddDialog::DoneAddDialog(bool resizeEnable,
                                         bool shadowBorder,
                                         bool winNativeEvent,
                                         QWidget *parent)
      ...
      CancelButton(new GradientButton(this))
{
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &DoneAddDialog::onCloseButtonClicked);
...
void DoneAddDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void DoneAddDialog::setDoneAddCategory(QString category) {
    rowOneContent->setText(category);
}
void DoneAddDialog::setDoneAddName(QString name) {
    rowTwoContent->setText(name);
}
void DoneAddDialog::setDoneAddNumber(QString number) {
    rowThreeContent->setText(number);
}
/*
 * TotalVLayout->setContentsMargins(0, 0, 0, 0);
