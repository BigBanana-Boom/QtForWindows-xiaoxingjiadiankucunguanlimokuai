#ifndef DONEADDCATEGORY_H
#define DONEADDCATEGORY_H
...
class DoneAddCategory : public QDialog
{
    Q_OBJECT
public:
    explicit DoneAddCategory(QWidget *parent = nullptr,
