...
DoneRemoveDialog::DoneRemoveDialog(bool resizeEnable,
                                   bool shadowBorder,
                                   bool winNativeEvent,
                                   QWidget *parent)
    ...
    CancelButton(new GradientButton(this))
{
    ...
    // 标题******************************************************************************
    contentWidgetTitle->setText("删 除 已 定");
    ...
    connect(closebutton, &QPushButton::clicked,
            this, &DoneRemoveDialog::onCloseButtonClicked);
...
void DoneRemoveDialog::onCloseButtonClicked()
{
    // 关闭窗口***************************************************************************
    close();
    // 关闭窗口***************************************************************************
}
void DoneRemoveDialog::setDoneRemoveID(QString id) {
    rowOneContent->setText(id);
}
void DoneRemoveDialog::setDoneRemoveDateTime(QString datetime) {
    rowTwoContent->setText(datetime);
}
void DoneRemoveDialog::setDoneRemoveCategory(QString category) {
    rowThreeContent->setText(category);
}
void DoneRemoveDialog::setDoneRemoveName(QString name) {
    rowFourContent->setText(name);
}
void DoneRemoveDialog::setDoneRemoveNumber(QString number) {
